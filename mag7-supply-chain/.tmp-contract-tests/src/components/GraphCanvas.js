...
export function GraphCanvas(props) {
    ...
    return (_jsx("section", { className: "graphWorkspace", children: _jsxs("div", { className: "graphViewport", "aria-describedby": instructionsId, children: [_jsx("div", { className: "graphViewportTextures", "aria-hidden": "true" }), _jsxs("div", { className: "graphStatsCluster", children: [_jsxs("div", { className: "graphStatCard", children: [_jsx("span", { children: "\u53EF\u89C6\u8282\u70B9" }), _jsx("strong", { children: visibleNodes })] }), _jsxs("div", { className: "graphStatCard", children: [_jsx("span", { children: "\u5173\u7CFB" }), _jsx("strong", { children: visibleRelations })] })] }), _jsxs("div", { className: "graphCanvasControls", children: [_jsx("button", { "aria-label": "\u56FE\u8C31\u8BBE\u7F6E", className: "graphControlButton", type: "button", children: _jsx(GearSix, { size: 16 }) }), _jsx("button", { "aria-label": "\u7F29\u5C0F\u56FE\u8C31", className: "graphControlButton", onClick: () => onZoomChange(Math.max(0.82, zoom - 0.1)), type: "button", children: _jsx(Minus, { size: 16 }) }), _jsx("button", { "aria-label": "\u653E\u5927\u56FE\u8C31", className: "graphControlButton", onClick: () => onZoomChange(Math.min(1.5, zoom + 0.1)), type: "button", children: _jsx(Plus, { size: 16 }) }), _jsx("button", { "aria-label": isFullscreen ? "退出全屏探索" : "进入全屏探索", "aria-pressed": isFullscreen, className: "graphControlButton", onClick: onFullscreenToggle, type: "button", children: _jsx(ArrowsOutSimple, { size: 16 }) })] }), _jsx("div", { className: "graphExpansionHint", children: expansionHint ? `展开中... ${expansionHint.summary}` : "展开中..." }), _jsx("div", { className: "graphLegendCopy", children: "Nodes distinguish group anchors, brand/legal naming, and facility operators instead of flattening all aliases into one surface." }), _jsx("p", { className: "srOnly", id: instructionsId, children: "\u4F7F\u7528\u56FE\u8C31\u5185\u7684\u8282\u70B9\u4E0E\u5173\u7CFB\u6309\u94AE\u8FDB\u884C\u63A2\u7D22\u3002\u9009\u62E9\u8282\u70B9\u53EF\u5237\u65B0\u6982\u89C8\uFF0C\u9009\u62E9\u5173\u7CFB\u53EF\u6253\u5F00\u8BC1\u636E\u4E0E\u5BA1\u8BA1\u4FE1\u606F\u3002" }), _jsxs("svg", { "aria-hidden": "true", focusable: "false", viewBox: "0 0 100 100", children: [_jsx("defs", { children: _jsxs("radialGradient", { id: "focusGlow", cx: "50%", cy: "50%", r: "60%", children: [_jsx("stop", { offset: "0%", stopColor: "rgba(255,107,87,0.95)" }), _jsx("stop", { offset: "55%", stopColor: "rgba(255,107,87,0.18)" }), _jsx("stop", { offset: "100%", stopColor: "rgba(255,107,87,0)" })] }) }), _jsxs("g", { transform: `scale(${zoom}) translate(${(1 - zoom) * 50} ${(1 - zoom) * 50})`, children: [graph.relations.map((relation) => {
                                ...
                                })] })] }), _jsxs("div", { className: "collapsedClusterBadge", children: [_jsx("span", { children: "\u5DF2\u6298\u53E0" }), _jsx("strong", { children: "18 \u4E2A\u8282\u70B9" })] }), _jsxs("div", { className: "miniMapCard", children: [_jsxs("div", { className: "miniMapCardHeader", children: [_jsx("strong", { children: "\u5168\u5C40\u7F29\u7565\u56FE" }), _jsx("span", { children: graph.focusCompany.displayName })] }), _jsx("div", { className: "miniMapFrame", children: graph.nodes.slice(0, 28).map((node) => (_jsx("i", { style: { left: `${node.x}%`, top: `${node.y}%` } }, node.id))) })] }), _jsxs("div", { className: "graphKeyboardDock", children: [_jsxs("div", { className: "graphKeyboardPanel", children: [_jsxs("div", { className: "graphKeyboardHeader", children: [_jsx("strong", { children: "\u8282\u70B9\u5FEB\u6377\u5217\u8868" }), _jsx("span", { children: graph.nodes.length })] }), _jsx("div", { className: "graphKeyboardList", children: graph.nodes.slice(0, 10).map((node) => {
                                        const isActive = node.id === activeNodeId;
                                        return (_jsxs("button", { "aria-pressed": isActive, className: isActive ? "graphListButton active" : "graphListButton", onClick: () => onNodeSelect(node), type: "button", children: [_jsx("span", { children: node.kindLabel }), _jsx("strong", { children: node.displayName }), _jsx("small", { children: node.secondaryLabel || node.region })] }, node.id));
                                    }) })] }), _jsxs("div", { className: "graphKeyboardPanel relationPanel", children: [_jsxs("div", { className: "graphKeyboardHeader", children: [_jsx("strong", { children: "\u5173\u7CFB\u8DEF\u5F84" }), _jsx("span", { children: graph.relations.length })] }), _jsx("div", { className: "graphKeyboardList", children: graph.relations.slice(0, 8).map((relation) => {
                                        const isActive = relation.id === activeRelationId;
                                    ...
                                    }) })] })] }), _jsxs("div", { className: "focusBreadcrumb", children: ["\u7126\u70B9\u8DEF\u5F84: ", graph.focusCompany.displayName, " \u2192 \u4F9B\u5E94\u94FE\u7F51\u7EDC \u2192 \u5168\u7403\u89C6\u56FE (", depth, "\u7EA7\u7A7F\u900F)"] })] }) }));
}
