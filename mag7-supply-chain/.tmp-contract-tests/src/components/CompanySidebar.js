...
export function CompanySidebar(props) {
    ...
    return (_jsxs("aside", { className: isOpen ? "evidenceSidebar isOpen" : "evidenceSidebar", "aria-hidden": !isOpen, children: [_jsxs("div", { className: "evidenceSidebarHeader", children: [_jsxs("div", { className: "evidenceSidebarCompany", children: [_jsx("div", { className: "evidenceSidebarLogo", children: company.ticker.slice(0, 1) }), _jsxs("div", { children: [_jsx("h3", { children: company.displayName }), _jsx("p", { children: "\u7126\u70B9\u516C\u53F8" })] })] }), _jsx("button", { "aria-label": "\u5173\u95ED\u8BC1\u636E\u4FA7\u680F", className: "closeSidebar", onClick: onClose, type: "button", children: _jsx(X, { size: 16 }) })] }), _jsxs("div", { className: "detailTabs", role: "tablist", "aria-label": "\u516C\u53F8\u8BE6\u60C5\u6807\u7B7E", children: [_jsx("button", { "aria-controls": overviewPanelId, "aria-selected": activeTab === "overview", className: activeTab === "overview" ? "tabButton active" : "tabButton", id: overviewTabId, onClick: () => onTabChange("overview"), onKeyDown: (event) => handleTabKeyDown(event, "overview"), ref: (node) => {
