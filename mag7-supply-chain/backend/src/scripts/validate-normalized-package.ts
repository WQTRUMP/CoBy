  ...
  JSON.stringify(
    {
      ...
      governanceBaseline: {
        path: summary.governance.sourcePath,
        authoritativeSnapshot: summary.governance.authoritativeSnapshot,
        activeCandidateShell: summary.governance.activeCandidateShell,
        published: summary.governance.published,
        allCandidates: summary.governance.allCandidates,
        candidateOnly: summary.governance.candidateOnly,
        realDataLaunch: summary.governance.realDataLaunch,
      },
