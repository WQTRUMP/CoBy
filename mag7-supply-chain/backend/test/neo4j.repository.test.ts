  ...
  it("maps subgraph rows via SOURCE_OF/TARGET_OF joins and groups evidence by traversed relation", async () => {
      ...
      new FakeRecord({
        ...
        rel: {
          properties: {
            ...
            skuGranularityNote: "Backfilled from authoritative manifest.",
        ...
        evidence: [
          {
            properties: {
              ...
              skuGranularityNote: "Inherited authoritative relation granularity.",
              skuGranularityIsBackfilled: true,
    ...
    expect(subgraph.relations[0]).toMatchObject({
      ...
      skuGranularityDetail: {
        ...
        raw: null,
        note: "Backfilled from authoritative manifest.",
        isBackfilled: true,
      },
      relationshipSubtype: "wafer_foundry",
      productScope: ["Apple silicon"],
    ...
    expect(subgraph.relations[0].evidence?.[0]).toMatchObject({
      ...
      skuGranularityDetail: {
        ...
        note: "Inherited authoritative relation granularity.",
        isBackfilled: true,
      },
    });
  });
